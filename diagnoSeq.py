#DIAGNOSTIC HAPLOTYPIC DETECTION
...
for h_file in h0_list:
    ...
    # Create paternal and maternal output files for diagnostic haplotypes
    PatDF = pd.DataFrame(columns=['SeqNames', 'Seq'])
    MatDF = pd.DataFrame(columns=['SeqNames', 'Seq'])


    for line in locusNumUniqH:
        # Get index numbers of locus "line" in hybrid, paternal and maternal data
    ...
    # Export the paternal and maternal diagnostic haplotype files of the hybrid indv.
